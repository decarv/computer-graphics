...
import {vec4} from "./MVnew.js";

export { randomFloatInRange, calculateAngle, rotatePoint, distance, angleDifference, randomAngle, randomCoordinates, fetchShaderSource, createShader, createProgram, flatten , FlatBuffer, makeBuffer, setAttribute, randomColor };
...
function randomCoordinates(canvasWidth, canvasHeight) {
